cat("Running R Wrapper for Adaptive boosting\n")
...
#Source files
file_name <- paste(sep="/", prog_dir, "ada_runPred.R")
source(file_name)

file_name <- paste(sep="/", prog_dir, "ada_makePred.R")
source(file_name)
...
#Run the predictions
ada_runPred(no_of_runs,out_dir)
