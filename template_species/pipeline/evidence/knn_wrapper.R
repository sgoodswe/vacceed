cat("Running R Wrapper for k-nearest neighbour classifier\n")
...
#Source files
file_name <- paste(sep="/", prog_dir, "knn_runPred.R")
source(file_name)

file_name <- paste(sep="/", prog_dir, "knn_makePred.R")
source(file_name)
...
#Run the predictions
knn_runPred(no_of_runs,out_dir)
